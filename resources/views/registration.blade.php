...
@section('content')
    ...
    <div class=" relative flex justify-center items-center w-screen h-[90%] ">
        <form action="{{ route('registration.post') }}" method="POST" class=" flex flex-col gap-9">
            @csrf
            <div class="flex flex-col gap-2">
                <span class="text-3xl font-bold">Registration</span>
            ...
            <div class="flex flex-col gap-9">
                ...
                <x-input name="email" label="Email" type="text" placeholder="Insert your email" />
